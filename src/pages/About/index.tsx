...
const About = () => {
	...
	return (
		<Layout>
			<SEO
				title="Nosotros"
				description="Conoce Tecnocom MZT - Empresa mexicana de TI y telecomunicaciones con sede en Sinaloa. Desde 2014 brindamos soluciones tecnológicas integrales con cobertura nacional."
				keywords="Tecnocom MZT, empresa TI, telecomunicaciones, Sinaloa, Mazatlán, soluciones tecnológicas, historia empresa"
				url="/nosotros"
			/>
			<div>
				<section className="w-full h-[600px] p-8 md:p-20 bg-cover bg-center flex items-center" style={{ backgroundImage: `url(${BannerAbout})` }} role="banner">
				...
				<section className='w-full pt-10 pb-10' role="main">
						...
						<div className="flex-1 text-center md:text-left w-full max-w-[566px]">
							<animated.div style={!isMobile ? animationPropsBanner2 : {}} className="animated-element">
								...
								<div className='flex justify-center md:justify-start'>
									<Link to="/contacto" className='button button--secondary flex min-w-[200px] poppins-regular'>
										Contáctanos
										<img src={IconArrow} className='border-l border-white/20 ml-4 pl-2 w-[25px]' alt="Icono flecha derecha" />
									</Link>
								</div>
							</animated.div>
						</div>
						...
						<div className='w-full'>
							<animated.div style={!isMobile ? animationPropsBanner7 : {}} className="animated-element w-full">
								<div className='w-full md:flex text-center md:text-left bg-blue items-center gap-8 text-white pt-10 pb-6 px-4 md:px-12 h-auto md:h-[243px] mb-4'>
									<h3 className="text-2xl md:text-3xl poppins-semibold text-principal mb-4">Misión</h3>
							...
							<animated.div style={!isMobile ? animationPropsBanner8 : {}} className="animated-element w-full">
								<div className='w-full md:flex text-center md:text-left bg-blue items-center gap-8 text-white pt-10 pb-6 px-4 md:px-12 h-auto md:h-[243px] mb-4'>
									<h3 className="text-2xl md:text-3xl poppins-semibold text-principal mb-4">Visión</h3>
									<p className="w-full max-w-[465px] mx-auto md:mx-0 text-text text-[18px] albert-sans-300 mb-4">
							...
							<animated.div style={!isMobile ? animationPropsBanner9 : {}} className="animated-element w-full">
								<div className='w-full md:flex bg-blue items-center gap-8 text-white pt-10 pb-6 px-4 md:px-12 h-auto md:h-[243px] mb-4'>
									<h3 className="text-2xl md:text-3xl poppins-semibold text-principal mb-4 text-center md:text-left">Valores</h3>
									<div className='px-8'>
										<ul>
