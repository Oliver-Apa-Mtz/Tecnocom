...
const SampleNextArrow = (props: any) => {
	...
	return (
		<div
			className={className}
			style={{ ...style, display: "block", background: "black", filter: 'invert(1)', padding: '10px', width: '40px', height: '40px', borderRadius: '50%', zIndex: 90 }}
			onClick={onClick}
		/>
	);
}
...
const Home = () => {
	...
	return (
		<Layout>
			<SEO
				title="Inicio"
				description="Tecnocom MZT - Infraestructura tecnológica que sostiene tu negocio. Redes de alta disponibilidad, centros de datos robustos y soluciones de conectividad en Mazatlán, Sinaloa."
				keywords="infraestructura tecnológica, redes empresariales, centros de datos, conectividad, Mazatlán, Sinaloa, TI, tecnología"
				url="/"
			/>
			<div>
				<section className="w-full md:h-[600px] lg:h-[1020px] p-8 md:p-20 bg-cover bg-center flex items-center" style={{ backgroundImage: `url(${BannerHome})` }} role="banner">
				...
				<section className="w-full -mt-[30px] md:-mt-[80px]" role="main">
					<animated.div style={!isMobile ? animationPropsBanner2 : {}} className="animated-element">
						<div className="max-w-[1360px] mx-auto px-[20px] flex justify-center md:gap-8 lg:gap-16 text-center flex-wrap lg:flex-nowrap">
							<div className='w-[80%] sm:w-[60%] lg:w-full md:max-w-[300px] lg:max-w-[360px] h-[306px] rounded-2xl shadow-xl flex items-center justify-center px-5 lg:px-10 py-6 bg-white mb-10'>
								<div>
									<img src={Icon1} className="w-[60px] lg:w-[80px] mx-auto mb-2" alt="Cobertura Nacional" />
									<h2 className="text-principal text-[20px] poppins-semibold mb-2">Cobertura Nacional:</h2>
									<p className="text-text text-[18px] px-0 lg:px-7 albert-sans-300">Soluciones optimizadas para cada región.</p>
								</div>
							</div>
							<div className='w-[80%] sm:w-[60%] lg:w-full md:max-w-[300px] lg:max-w-[360px] h-[306px] rounded-2xl shadow-xl flex items-center justify-center px-5 lg:px-10 py-6 bg-white mb-10'>
								<div>
									<img src={Icon2} className="w-[60px] lg:w-[80px] mx-auto mb-2" alt="Expertise Multisectorial" />
									<h2 className="text-principal text-[20px] poppins-semibold mb-2">Expertise Multisectorial:</h2>
							...
							<div className='w-[80%] sm:w-[60%] lg:w-full md:max-w-[300px] lg:max-w-[360px] h-[306px] rounded-2xl shadow-xl flex items-center justify-center px-5 lg:px-10 py-6 bg-white'>
								<div>
									<img src={Icon3} className="w-[60px] lg:w-[80px] mx-auto mb-2" alt="Atención Personalizada" />
									<h2 className="text-principal text-[20px] poppins-semibold mb-2">Atención Personalizada:</h2>
				...
				<section className="w-full mt-20 mb-10">
					<div className="max-w-[1360px] mx-auto px-[20px] flex flex-wrap items-center justify-center gap-8">
						<img src={Logo1} className="h-14" alt="Icono Apple" />
						<img src={Logo2} className="h-14" alt="Icono Dell" />
						<img src={Logo3} className="h-14" alt="Icono Lenovo" />
						<img src={Logo4} className="h-14" alt="Icono HP" />
						<img src={Logo5} className="h-14" alt="Icono Asus" />
						<img src={Logo6} className="h-14" alt="Icono Acer" />
						<img src={Logo7} className="h-14" alt="Icono Zebra" />
						<img src={Logo8} className="h-14" alt="Icono Honeywell" />
						<img src={Logo9} className="h-14" alt="Icono Polycom" />
					</div>
				</section>
				...
				<section className='w-full'>
					<div className="w-full max-w-[1360px] mx-auto px-[20px] pt-10 text-center">
						<h2 className="text-[30px] md:text-[40px] lg:text-[50px] poppins-semibold text-secundario mb-4">Explora nuestros servicios</h2>
					...
					<div className='p-6 max-w-[1580px] mx-auto'>
						<animated.div style={!isMobile ? animationPropsBanner5 : {}} className="animated-element">
							<Slider {...settings}>
								<div className="w-full relative" style={{ outline: 'none' }}>
									<div className="px-8 py-4 min-h-[116px] lg:min-h-max">
										<h3 className="text-[20px] md:text-[24px] lg:text-[34px] poppins-semibold text-principal">Hogar</h3>
								...
								<div className="w-full relative" style={{ outline: 'none' }}>
									<div className="px-8 py-4 min-h-[116px] lg:min-h-max">
										<h3 className="text-[20px] md:text-[24px] lg:text-[34px] poppins-semibold text-principal">Hospitales</h3>
								...
								<div className="w-full relative" style={{ outline: 'none' }}>
									<div className="px-8 py-4 min-h-[116px] lg:min-h-max">
										<h3 className="text-[20px] md:text-[24px] lg:text-[34px] poppins-semibold text-principal">Hotelería</h3>
								...
								<div className="w-full relative" style={{ outline: 'none' }}>
									<div className="px-8 py-4 min-h-[116px] lg:min-h-max">
										<h3 className="text-[20px] md:text-[24px] lg:text-[34px] poppins-semibold text-principal">Industria</h3>
